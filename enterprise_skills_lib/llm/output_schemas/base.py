...
from enterprise_skills_lib.llm.output_sanitizer import normalize_answer_content
...
class LLMOutputBase(BaseModel):
    ...
    def normalize_string_fields(self):
        ...
        Recurses into nested BaseModel instances and lists.
        """
        _normalize_model_strings(self)
        return self


class SimpleTextOutput(LLMOutputBase):
    """Simple schema for unstructured text responses via FallbackProvider."""
    text: str
